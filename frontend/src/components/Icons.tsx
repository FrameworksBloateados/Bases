...
export function ErrorCircleIcon({className = 'w-5 h-5'}: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function UploadIcon({className = 'w-12 h-12'}: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function UndoIcon({className = 'w-3 h-3'}: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function CsvFileIcon({className = 'w-4 h-4'}: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function SpinnerIcon({className = 'animate-spin h-4 w-4'}: IconProps) {
  return (
